            ...
            (
                SELECT CASE 
                        WHEN pt.v LIKE '{attributes,%'
                            THEN format('attrs #>> ''''%s''''', REPLACE(t.parsed #>> '{}','{attributes,','{'))
...
SELECT pg_catalog.setval('dev.ver_id_seq', 38, true);
