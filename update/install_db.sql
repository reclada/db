...
CREATE VIEW reclada.v_object_display AS
 SELECT obj.id,
    obj.guid,
    ((obj.attributes ->> 'forClass'::text))::uuid AS for_class,
    (obj.attributes ->> 'caption'::text) AS caption,
     ...
     JOIN ( SELECT t_1.id,
           ...
           FROM ( SELECT t_2.id,
                   ...
                   FROM ((reclada.v_active_object t_2
                     JOIN reclada.v_object_display od ON ((od.for_class = t_2.class)))
...
SELECT pg_catalog.setval('reclada.transaction_id', 63, true);
