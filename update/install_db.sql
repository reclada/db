...
--
-- Name: reclada_object_create(jsonb, text); Type: FUNCTION; Schema: api; Owner: -
--

CREATE FUNCTION api.reclada_object_create(data jsonb, draft text DEFAULT 'false'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    data_jsonb       jsonb;
...
--
-- Name: reclada_object_delete(jsonb, text); Type: FUNCTION; Schema: api; Owner: -
--

CREATE FUNCTION api.reclada_object_delete(data jsonb, draft text DEFAULT 'false'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    class         text;
...
--
-- Name: reclada_object_list(jsonb, text); Type: FUNCTION; Schema: api; Owner: -
--

CREATE FUNCTION api.reclada_object_list(data jsonb DEFAULT NULL::jsonb, draft text DEFAULT 'false'::text) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    class               text;
   ...
   FROM (reclada.v_active_object t
     JOIN ( SELECT t_1.id,
           ...
           FROM ( SELECT t_2.id,
                   ...
                   FROM ((reclada.v_active_object t_2
                     JOIN reclada.v_object_display od ON ((od.class_guid = t_2.class)))
...
63	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"$defs": {"displayType": {"type": "object", "required": ["orderColumn", "orderRow"], "properties": {"orderRow": {"type": "array", "items": {"type": "object", "patternProperties": {"^{.*}$": {"enum": ["ASC", "DESC"], "type": "string"}}}}, "orderColumn": {"type": "array", "items": {"type": "string"}}}}}, "required": ["classGUID", "caption"], "properties": {"card": {"$ref": "#/$defs/displayType"}, "flat": {"type": "bool"}, "list": {"$ref": "#/$defs/displayType"}, "table": {"$ref": "#/$defs/displayType"}, "caption": {"type": "string"}, "preview": {"$ref": "#/$defs/displayType"}, "classGUID": {"type": "string"}}}, "version": "1", "forClass": "ObjectDisplay"}	62	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	74c22b58-ecec-4666-90b1-23e5bb04d98e	\N
64	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Object display", "classGUID": "74c22b58-ecec-4666-90b1-23e5bb04d98e"}	63	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	d5f8b72e-c4cc-4d60-97e3-8fdcd7e5969e	\N
65	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Data row", "classGUID": "7643b601-43c2-4125-831a-539b9e7418ec"}	64	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	4dfb7582-e919-42a0-968a-da69c5efe93c	\N
66	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Text block", "classGUID": "9ed31858-a681-49fb-9e64-250b1afaf691"}	65	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	4e445a19-3724-4c82-b4ea-81c93e877d7b	\N
67	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Message", "classGUID": "54f657db-bc6a-4a37-8fb6-8566aee49b33"}	66	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	ea949420-1194-4edd-8dca-929fb94e2e6b	\N
68	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Page", "classGUID": "3ed1c180-a508-4180-9281-2f9b9a9cd477"}	67	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	2b7b086e-70db-4b9d-9666-6c2324eeb5c4	\N
69	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Document", "classGUID": "85d32073-4a00-4df7-9def-7de8d90b77e0"}	68	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	bcd07282-612b-4255-89e5-44d4b824e6ea	\N
70	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Json schema", "classGUID": "5362d59b-82a1-4c7c-8ec3-07c256009fb0"}	69	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	fafe4139-cfbc-46f1-8686-4ad27b061c4c	\N
71	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"caption": "Job", "classGUID": "75a8fd8b-f709-445c-a551-e8454c0ef179"}	70	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	351a69d9-9368-49c5-991f-a353dde4b739	\N
72	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"card": {"orderRow": [{"{attributes,name}": "ASC"}, {"{attributes,mimeType}": "DESC"}], "orderColumn": ["{attributes,name}", "{attributes,mimeType}", "{attributes,tags}", "{status}", "{createdTime}", "{transactionID}"]}, "list": {"orderRow": [{"{attributes,name}": "ASC"}, {"{attributes,mimeType}": "DESC"}], "orderColumn": ["{attributes,name}", "{attributes,mimeType}", "{attributes,tags}", "{status}", "{createdTime}", "{transactionID}"]}, "table": {"orderRow": [{"{attributes,name}": "ASC"}, {"{attributes,mimeType}": "DESC"}], "{status}": {"width": 250, "caption": "Status", "displayCSS": "status"}, "orderColumn": ["{attributes,name}", "{attributes,mimeType}", "{attributes,tags}", "{status}", "{createdTime}", "{transactionID}"], "{createdTime}": {"width": 250, "caption": "Created time", "displayCSS": "createdTime"}, "{transactionID}": {"width": 250, "caption": "Transaction", "displayCSS": "transactionID"}, "{attributes,name}": {"width": 250, "caption": "File name", "behavior": "preview", "displayCSS": "name"}, "{attributes,tags}": {"items": {"class": "e12e729b-ac44-45bc-8271-9f0c6d4fa27b", "behavior": "preview", "displayCSS": "link"}, "width": 250, "caption": "Tags", "displayCSS": "arrayLink"}, "{attributes,checksum}": {"width": 250, "caption": "Checksum", "displayCSS": "checksum"}, "{attributes,mimeType}": {"width": 250, "caption": "Mime type", "displayCSS": "mimeType"}}, "caption": "Files", "preview": {"orderRow": [{"{attributes,name}": "ASC"}, {"{attributes,mimeType}": "DESC"}], "orderColumn": ["{attributes,name}", "{attributes,mimeType}", "{attributes,tags}", "{status}", "{createdTime}", "{transactionID}"]}, "classGUID": "c7fc0455-0572-40d7-987f-583cc2c9630c"}	71	2021-11-17 14:11:31.38773+00	16d789c1-1b4e-4815-b70c-4ef060e90884	74c22b58-ecec-4666-90b1-23e5bb04d98e	ecbee66c-2abe-40e7-aae6-7374e2ba999e	\N
73	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"Lambda": "s3_get_presigned_url_dev5", "Region": "eu-west-1", "Environment": "K8S"}	72	2021-11-22 15:10:24.705789+00	16d789c1-1b4e-4815-b70c-4ef060e90884	ea01e538-fa4d-49de-ad05-dad73a5dbaca	da5fc0a5-eec6-41f0-9ef4-5411a4406fd5	\N
74	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	73	2021-11-22 15:10:24.915158+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	11a45dce-e6e4-4fd9-a497-8a33ff314e64	\N
75	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	74	2021-11-22 15:10:25.164714+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	1d336238-bd26-432c-b61b-584582f295ad	\N
76	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	75	2021-11-22 15:10:25.416868+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	099787ba-27bd-41b5-9fb4-285df8b6133d	\N
77	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	76	2021-11-22 15:10:25.669707+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	3ce6885d-9628-4ffd-b687-8cd9f1ca57f1	\N
78	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	77	2021-11-22 15:10:25.918941+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	f31eb14b-6366-4ba9-b9da-4da230f24227	\N
79	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "required": ["forClass", "name"], "properties": {"uri": {"type": "string"}, "name": {"type": "string"}, "tags": {"type": "array", "items": {"type": "string"}}, "classGUID": {"type": "string"}}}, "version": "1", "forClass": "Asset"}	78	2021-11-22 15:10:27.965412+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	68e48c76-3907-4041-9b38-c1a37e831347	92a95f66-e28e-4ebc-9f33-3568fc5a281e
80	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "required": ["forClass", "connectionString", "name"], "properties": {"uri": {"type": "string"}, "name": {"type": "string"}, "tags": {"type": "array", "items": {"type": "string"}}, "classGUID": {"type": "string"}, "connectionString": {"type": "string"}}}, "version": "1", "forClass": "DBAsset"}	79	2021-11-22 15:10:27.965412+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	4adbe033-42f2-4e3d-87f0-5bf86b4b0737	68e48c76-3907-4041-9b38-c1a37e831347
50	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "required": ["subject", "type", "object"], "properties": {"tags": {"type": "array", "items": {"type": "string"}}, "type": {"type": "string", "enum ": ["params"]}, "object": {"type": "string", "minLength": 36}, "subject": {"type": "string", "minLength": 36}}}, "version": "1", "forClass": "Relationship"}	27	2021-09-22 14:53:04.158111+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	2d054574-8f7a-4a9a-a3b3-0400ad9d0489	\N
\.
...
SELECT pg_catalog.setval('dev.ver_id_seq', 44, true);
...
SELECT pg_catalog.setval('reclada.object_id_seq', 80, true);
...
SELECT pg_catalog.setval('reclada.transaction_id', 79, true);
