...
60	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "required": ["schema", "function"], "properties": {"tags": {"type": "array", "items": {"type": "string"}}, "schema": {"type": "object"}, "function": {"type": "string"}}}, "version": "1", "forClass": "DTOJsonSchema"}	59	2021-10-30 15:39:02.312212+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	5d33b041-1546-46e0-b343-0a2f0e02fb8a	ab9ab26c-8902-43dd-9f1a-743b14a89825
61	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"id": "expr", "type": "object", "properties": {"value": {"type": "array", "items": {"anyOf": [{"type": "string"}, {"type": "number"}, {"$ref": "expr"}, {"type": "array", "items": {"type": "string"}}]}, "minItems": 1}, "operator": {"enum": ["=", "LIKE", "NOT LIKE", "||", "~", "!~", "~*", "!~*", "SIMILAR TO", ">", "<", "<=", "!=", ">=", "AND", "OR", "NOT", "#", "IS", "IS NOT", "IN", ",", "@>", "<@", "+", "-", "*", "/", "%", "^", "|/", "||/", "!!", "@", "&", "|", "<<", ">>"], "type": "string"}}}, "function": "reclada_object.get_query_condition_filter"}	60	2021-10-30 15:39:02.312212+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5d33b041-1546-46e0-b343-0a2f0e02fb8a	96a0f308-c24e-4f52-bced-d88fb3cf7d23	\N
\.
...
SELECT pg_catalog.setval('reclada.object_id_seq', 61, true);
...
SELECT pg_catalog.setval('reclada.transaction_id', 60, true);
