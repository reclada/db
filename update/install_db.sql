...
--
-- Name: create(jsonb, jsonb, uuid); Type: FUNCTION; Schema: reclada_object; Owner: -
--

CREATE FUNCTION reclada_object."create"(data_jsonb jsonb, user_info jsonb DEFAULT '{}'::jsonb, _parent_guid uuid DEFAULT NULL::uuid) RETURNS jsonb
    LANGUAGE plpgsql
    AS $$
DECLARE
    branch        uuid;
...
CREATE VIEW reclada.v_object AS
 WITH t AS (
         SELECT obj.id,
            ...
            obj.parent_guid
           FROM reclada.object obj
          WHERE ((obj.attributes ->> 'revision'::text) IS NULL)
        UNION ALL
         SELECT obj.id,
            obj.guid,
            obj.class,
            r.num,
            ((obj.attributes ->> 'revision'::text))::uuid AS revision,
            obj.attributes,
            obj.status,
            obj.created_time,
            obj.created_by,
           ...
           FROM (reclada.object obj
             JOIN ( SELECT ((r_1.attributes ->> 'num'::text))::bigint AS num,
                  ...
                  WHERE (r_1.class = ( SELECT reclada_object.get_guid_for_class('revision'::text) AS get_guid_for_class))) r ON ((r.guid = ((obj.attributes ->> 'revision'::text))::uuid)))
          WHERE ((obj.attributes ->> 'revision'::text) <> ''::text)
        )
 SELECT t.id,
    t.guid AS obj_id,
    t.class,
...
63	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	62	2021-10-22 10:07:40.617083+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	2c92525b-dcd6-4e3d-8034-3930f21b2e1c	\N
...
64	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	63	2021-10-22 10:07:40.765404+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	d847e0a7-2ba3-43ff-b29b-e6eee03ff062	\N
...
60	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"Lambda": "s3_get_presigned_url_dev2", "Environment": "K8S"}	59	2021-10-22 10:07:40.15192+00	16d789c1-1b4e-4815-b70c-4ef060e90884	ea01e538-fa4d-49de-ad05-dad73a5dbaca	6cc22105-0110-4223-a647-44f606b68e1a	\N
61	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	60	2021-10-22 10:07:40.30508+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	84e702e5-569b-47b1-9c5d-c1a72a152aea	\N
62	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	61	2021-10-22 10:07:40.460628+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	b99c1c61-35f1-47b8-8a05-0d021a7d7621	\N
65	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"task": "512a3dde-23c7-4771-b180-20f8781ac084", "type": "K8S", "status": "down", "command": "", "environment": "7b196912-d973-40a9-b0e2-15ecbd921b2f"}	64	2021-10-22 10:07:40.910956+00	16d789c1-1b4e-4815-b70c-4ef060e90884	b6e879da-731f-48c3-99b5-e48d73a74930	636f5360-e567-4fcd-91ad-9cddcab6594e	\N
66	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"num": 2, "user": "", "branch": "", "dateTime": "2021-10-22 10:07:41.926999+00"}	65	2021-10-22 10:07:41.926999+00	16d789c1-1b4e-4815-b70c-4ef060e90884	0f317fbd-8861-4d68-82ce-de7241d7db0f	4f382de2-e7de-4d0d-9bb9-8a662918a4df	\N
18	9dc0a032-90d6-4638-956e-9cd64cd2900c	{"name": "defaultDataSet", "revision": "a04d127e-5ea0-4683-8eff-2ea8d1ba5f24", "dataSources": []}	10	2021-09-22 14:50:50.411942+00	16d789c1-1b4e-4815-b70c-4ef060e90884	be193cf5-3156-4df4-8c9b-58b09524ce2f	10c400ff-a328-450d-ae07-ce7d427d961c	\N
67	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"name": "defaultDataSet", "revision": "4f382de2-e7de-4d0d-9bb9-8a662918a4df", "dataSources": []}	10	2021-10-22 10:07:41.926999+00	16d789c1-1b4e-4815-b70c-4ef060e90884	be193cf5-3156-4df4-8c9b-58b09524ce2f	10c400ff-a328-450d-ae07-ce7d427d961c	\N
\.
...
SELECT pg_catalog.setval('dev.ver_id_seq', 40, true);
...
SELECT pg_catalog.setval('reclada.object_id_seq', 67, true);
...
SELECT pg_catalog.setval('reclada.transaction_id', 65, true);
