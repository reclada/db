     ...
     JOIN ( SELECT 'File'::text AS class_name,
        ...
        UNION
         SELECT 'Document'::text,
            'fileGUID'::text) pk ON ((pk.class_name = obj.for_class)));
...
SELECT pg_catalog.setval('dev.t_dbg_id_seq', 21, true);
...
SELECT pg_catalog.setval('dev.ver_id_seq', 34, true);
