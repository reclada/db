...
60	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "required": ["schema", "function"], "properties": {"tags": {"type": "array", "items": {"type": "string"}}, "schema": {"type": "object"}, "function": {"type": "string"}}}, "version": "1", "forClass": "DTOJsonSchema"}	59	2021-10-30 16:57:01.999237+00	16d789c1-1b4e-4815-b70c-4ef060e90884	5362d59b-82a1-4c7c-8ec3-07c256009fb0	e406b093-b0bf-4db1-bcc5-d40eb4fc6e95	ab9ab26c-8902-43dd-9f1a-743b14a89825
61	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"id": "expr", "type": "object", "required": ["value", "operator"], "properties": {"value": {"type": "array", "items": {"anyOf": [{"type": "string"}, {"type": "number"}, {"$ref": "expr"}, {"type": "array", "items": {"type": "string"}}]}, "minItems": 1}, "operator": {"enum": ["=", "LIKE", "NOT LIKE", "||", "~", "!~", "~*", "!~*", "SIMILAR TO", ">", "<", "<=", "!=", ">=", "AND", "OR", "NOT", "#", "IS", "IS NOT", "IN", ",", "@>", "<@", "+", "-", "*", "/", "%", "^", "|/", "||/", "!!", "@", "&", "|", "<<", ">>"], "type": "string"}}}, "function": "reclada_object.get_query_condition_filter"}	60	2021-10-30 16:57:01.999237+00	16d789c1-1b4e-4815-b70c-4ef060e90884	e406b093-b0bf-4db1-bcc5-d40eb4fc6e95	7f478adc-3530-4a72-8cef-aee0083b4c75	\N
62	3748b1f7-b674-47ca-9ded-d011b16bbf7b	{"schema": {"type": "object", "anyOf": [{"required": ["transactionID"]}, {"required": ["class"]}, {"required": ["filter"]}], "properties": {"class": {"type": "string"}, "limit": {"anyOf": [{"enum": ["ALL"], "type": "string"}, {"type": "integer"}]}, "filter": {"type": "object"}, "offset": {"type": "integer"}, "orderBy": {"type": "array", "items": {"type": "object", "required": ["field"], "properties": {"field": {"type": "string"}, "order": {"enum": ["ASC", "DESC"], "type": "string"}}}}, "transactionID": {"type": "integer"}}}, "function": "reclada_object.list"}	61	2021-10-30 16:57:01.999237+00	16d789c1-1b4e-4815-b70c-4ef060e90884	e406b093-b0bf-4db1-bcc5-d40eb4fc6e95	ff6d2ddd-2475-4eb5-9282-76194a4e4542	\N
\.
...
SELECT pg_catalog.setval('dev.ver_id_seq', 42, true);
...
SELECT pg_catalog.setval('reclada.transaction_id', 61, true);
